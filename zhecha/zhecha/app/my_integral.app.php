...
class My_integralApp extends MemberbaseApp
{
    ...
    function index()
    {
        ...
        $this->_curlocal(LANG::get('member_center'),   'index.php?app=member',
                         LANG::get('my_integral'),         'index.php?app=my_integral',
                         LANG::get($curlocal)
          );
    ...
    function _get_member_submenu()
    {
        return array(
			...
			array(
                ...
                'url'   => 'index.php?app=my_integral&type=integral_income',
            ),
			array(
                'name'  => 'integral_pay',
                'url'   => 'index.php?app=my_integral&type=integral_pay',
            ),
			array(
                'name'  => 'frozen_integral',
                'url'   => 'index.php?app=my_integral&type=integral_frozen',
            ),
        );
    }
}
