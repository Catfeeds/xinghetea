...
class My_commentApp extends StoreadminbaseApp
{
    ...
    function index()
    {
        ...
        $conditions = ' AND seller_id = '.$_SESSION['user_info']['user_id'];
        switch ($type)
        {
            case 'all_comment':
                $conditions .= ' ';
        ...
        $this->_curlocal(LANG::get('member_center'),    'index.php?app=member',
                         LANG::get('my_comment'), 'index.php?app=my_comment',
        ...
        $this->assign('store_id',$this->visitor->get('store_id'));//增加store_id,兼容产品共用 by PwordC
        //dump($my_comment_data);die();
        ...
        if (!IS_POST)
        {
            ...
            if ($my_comment_data['reply_comment'] != '')
            {
                ...
                return;
                    ...
                    /* 当前位置 */
            $this->_curlocal(LANG::get('member_center'),    'index.php?app=member',
                             LANG::get('my_qa'), 'index.php?app=my_comment',
                             LANG::get('reply'));
