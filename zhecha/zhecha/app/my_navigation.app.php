...
class My_navigationApp extends StoreadminbaseApp
{
    ...
    function add()
    {
        ...
        else
        {
            ...
            $this->show_message('add_navigation_successed', '', 'index.php?app=my_navigation');
        }
    }
    function edit()
    {
        ...
        else
        {
            ...
            $this->show_message('edit_navigation_successed', '', 'index.php?app=my_navigation');
        }
    }
    function drop()
    {
    ...
    function _get_member_submenu()
    {
        $menus = array(
			...
			array(
				'name' => 'add_navigation',
				'url'  => 'index.php?app=my_navigation&amp;act=add',
			),
        );
		if(ACT == 'edit') {
			$menus[] = array(
