...
<style type="text/css">
.page-format {border:0px; background:none;}
</style>
<div id="page-goods" class="page-goods" style="margin-bottom:100px;"> 
    ...
    <ul class="menus-tab clearfix" >
        ...
        <li class="active"><a href="<?php echo url('app=goods&act=qa&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['store_id']. ''); ?>#module">我要咨询</a></li>
    </ul>
