...
?>
		<div class="mealeach J_MealEach clearfix <?php if (! ($this->_foreach['fe_meal']['iteration'] <= 1)): ?>hidden<?php endif; ?>">
			<ul class="master-goods float-left">
				<li>
					<s class="plus"></s>
					<div class="pic"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['store_id']. ''); ?>" target="_blank" title="<?php echo $this->_var['goods']['goods_name']; ?>"><img src="<?php echo $this->_var['goods']['default_image']; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>" width="60" height="60" /></a></div>
					<div class="desc"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['store_id']. ''); ?>" target="_blank" title="<?php echo $this->_var['goods']['goods_name']; ?>"><?php echo htmlspecialchars(sub_str($this->_var['goods']['goods_name'],40)); ?></a></div>
...
?>
					<li>
						...
						<div class="pic"><a href="<?php echo url('app=goods&id=' . $this->_var['item']['goods_id']. '&store_id=' . $this->_var['store_id']. ''); ?>" target="_blank" title="<?php echo $this->_var['item']['goods_name']; ?>"><img src="<?php echo $this->_var['item']['default_image']; ?>" alt="<?php echo $this->_var['item']['goods_name']; ?>" width="60" height="60" /></a></div>
						<div class="desc"><a href="<?php echo url('app=goods&id=' . $this->_var['item']['goods_id']. '&store_id=' . $this->_var['store_id']. ''); ?>" target="_blank" title="<?php echo $this->_var['item']['goods_name']; ?>"><?php echo htmlspecialchars(sub_str($this->_var['item']['goods_name'],40)); ?></a></div>
						<div class="price"><?php echo price_format($this->_var['item']['price']); ?></div>
					</li>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
				</ul>
			</div>
			<ul class="buy float-left clearfix">
				<li class="buy-info">
					<s class="eq"></s>
					...
					<div class="meal-price"><b><?php echo price_format($this->_var['meal']['price']); ?></b></div>
					<div class="original-price"><del><?php echo price_format($this->_var['meal']['sub_price']); ?></del></div>
					<div class="save-price">立省：<?php echo price_format($this->_var['meal']['save_price']); ?></div>
