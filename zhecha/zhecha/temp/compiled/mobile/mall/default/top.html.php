...
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'mobile/jquery.slides.min.js'; ?>" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'mobile/ecmall.js'; ?>" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'mobile/jquery.lazyload.js'; ?>" charset="utf-8"></script>
