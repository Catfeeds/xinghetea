...
?>
					<li> 
						<a class="gcategory-value <?php if (($this->_foreach['fe_gcategory']['iteration'] == $this->_foreach['fe_gcategory']['total'])): ?>gcategory-value-last<?php endif; ?>" href="<?php echo url('app=search&cate_id=' . $this->_var['gcategory']['id']. ''); ?>"><i></i><span><?php echo htmlspecialchars($this->_var['gcategory']['value']); ?></span></a>
...
?> 
								<a href="<?php echo url('app=search&cate_id=' . $this->_var['child']['id']. ''); ?>" class="child-value"><span><?php echo htmlspecialchars($this->_var['child']['value']); ?></span></a> 
