...
?>
		<div class="table-list mb10">
			<ul>
				...
				<li class="clearfix"> <span class="th float-left"><em>收/支</em></span> <span class="td float-left"><em class="f60">支出</em></span> </li>
				...
				<li class="clearfix"> <span class="th float-left"><em>资金渠道</em></span> <span class="td float-left"><em><?php echo $this->_var['record']['card_info']['bank_name']; ?> <font class="gray"><?php echo $this->_var['record']['card_info']['num']; ?></font></em></span> </li>
				<li class="clearfix"> 
		...
		<div class="notice-word mt10">
			<p>没有符合条件的记录 <a href="<?php echo url('app=deposit&act=record'); ?>">马上提现</a></p>
		</div>
