    ...
    <table class="infoTable">
      ...
      <th class="paddingT15"> 选择相关联的品牌:</th>
         <td class="paddingT15 wordSpacing5" >
            ...
            <label class="field_notice">优先级最高，如果搜索条件中同时有品牌，关键词，分类的，则优先显示品牌对应的旗舰店。</label>
         </td>
      </tr>
      <tr>
        <th class="paddingT15"> <label>店铺相关关键字:</label></th>
        <td class="paddingT15 wordSpacing5">
        	<input id="keyword" name="keyword" value="<?php echo $this->_var['ultimate']['keyword']; ?>" type="text" />
            <label class="field_notice">优先级次之，如果搜索条件中同时有关键词，分类的，则优先显示关键词对应的旗舰店。</label>
        </td>
      </tr>
      <tr>
      <th class="paddingT15"> 选择相关联的商品分类:</th>
         <td class="paddingT15 wordSpacing5" >
            ...
            <label class="field_notice">优先级最低，如果搜索条件中没有品牌和关键词，则显示该分类对应的旗舰店（不显示该分类下的子分类对应的旗舰店）。</label>
         </td>
      </tr>
      ...
      <tr>
        ...
        <td class="paddingT15">
          <span class="onoff">
          	<label class="cb-enable <?php if ($this->_var['ultimate']['status']): ?>selected<?php endif; ?>">开启</label>
          	<label class="cb-disable <?php if (! $this->_var['ultimate']['status']): ?>selected<?php endif; ?>">关闭</label>
            <input name="status" value="1" type="radio" <?php if ($this->_var['ultimate']['status']): ?>checked<?php endif; ?>>
            <input name="status" value="0" type="radio" <?php if (! $this->_var['ultimate']['status']): ?>checked<?php endif; ?>>
          </span>
