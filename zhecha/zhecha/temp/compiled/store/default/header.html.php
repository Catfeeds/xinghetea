...
?>
					<div <?php if (($this->_foreach['fe_cart']['iteration'] == $this->_foreach['fe_cart']['total'])): ?>style="border:0px;"<?php endif; ?> class="clearfix list J_CartItem-<?php echo $this->_var['cart']['rec_id']; ?>">
						<div class="goods-img"> <a href="<?php echo url('app=goods&id=' . $this->_var['cart']['goods_id']. '&store_id=' . $this->_var['cart']['store_id']. ''); ?>" target="_top"><img alt="<?php echo $this->_var['cart']['goods_name']; ?>" src="<?php echo $this->_var['cart']['goods_image']; ?>" width="40" height="40"></a> </div>
						<div class="goods-title"> <a title="<?php echo $this->_var['cart']['goods_name']; ?>" href="<?php echo url('app=goods&id=' . $this->_var['cart']['goods_id']. '&store_id=' . $this->_var['cart']['store_id']. ''); ?>" target="_top"><?php echo $this->_var['cart']['goods_name']; ?></a> </div>
...
?>
							<div class="item">
								<div class="pborder">
									<p><a href="<?php echo url('app=search&cate_id=' . $this->_var['category']['id']. ''); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['category']['value']); ?></a><i></i><b class="line"></b></p>
								</div>
...
?> 
									...
									<div class="catbrand float-left"> <a class="btn-channel" href="<?php echo url('app=search&cate_id=' . $this->_var['category']['id']. ''); ?>"><?php echo sub_str(htmlspecialchars($this->_var['category']['value']),16); ?><ins></ins></a>
...
?> 
											<a href="<?php echo $this->_var['ads']['link_url']; ?>" target="_blank" class="mb10"><img src="<?php echo $this->_var['ads']['file_path']; ?>" width="180" height="140" /></a> 
											<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
										</p>
									</div>
								</div>
...
<div id="nav" class="w-full">
	...
	<div class="shop-nav w-full" <?php if ($this->_var['store']['nav_color']): ?> style="background:<?php echo $this->_var['store']['nav_color']; ?>"<?php endif; ?>>
        <ul class="w J_ShopNav">
            ...
            <li><a href="<?php echo $this->_var['site_url']; ?>/<?php echo url('app=store&act=groupbuy&id=' . $this->_var['store']['store_id']. ''); ?>"><span>团购活动</span></a></li>
            <?php endif; ?>
...
?>
            ...
            <?php endif; ?>
            <?php if (( $_GET['app'] == 'goods' && $_GET['id'] ) || ( $_GET['app'] == 'groupbuy' && $_GET['id'] )): ?>
