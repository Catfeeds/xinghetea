...
?>
console.log(<?php echo $this->_var['spec']['price_1']; ?>);
console.log(<?php echo $this->_var['spec']['price_2']; ?>);console.log(<?php echo $this->_var['spec']['price_3']; ?>);console.log(<?php echo $this->_var['spec']['price_4']; ?>);console.log(<?php echo $this->_var['spec']['price_5']; ?>);
...
?> 
			...
			<div class="collect-goods"> <a href="javascript:collect_goods(<?php echo $this->_var['goods']['goods_id']; ?>,<?php echo $this->_var['store_id']; ?>);"> </a> </div>
	...
	<div class="col-main ml20 goods-attr ">
		<div class="goods-name mb10"> <?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?> </div>
		<div class="attribute">
			<div class="attr-detail float-left">
				<div class="rate pb10">
					<p class="J_IsPro" <?php if (! $this->_var['goods']['_specs']['0']['pro_price']): ?>style="display:none"<?php endif; ?>> <span class="t"> 零<ins style="margin:0 6px;">售</ins>价： </span> <span class="price" ectype="goods_price"> <del><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?>1212</del> </span><br />
					<p class="J_IsPro" <?php if (! $this->_var['goods']['_specs']['0']['pro_price']): ?>style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价： </span> <span class="price" ectype="goods_price_i"> <del><?php echo price_format($this->_var['goods']['integral_price']); ?>+<?php echo $this->_var['goods']['max_exchange']; ?>积分</del> </span><br />						
					...
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 零<ins style="margin:0 6px;">售</ins>价： </span> <span class="price" ectype="goods_price" <?php if (! $this->_var['price_0'] && ! $this->_var['vip_price_status_off']): ?>style="text-decoration:line-through;font-size:16px;color:#285bcc;"<?php endif; ?>> <?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?> </span> </p>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价： </span> <span class="price" ectype="goods_price_i"><?php echo price_format($this->_var['goods']['integral_price']); ?>+<?php echo $this->_var['goods']['max_exchange']; ?>积分</span></p>						
					
					<?php if (! $this->_var['price_0']): ?>
					<?php if ($this->_var['price_1']): ?>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价：</span> <span class="price" ectype="goods_price_1"><?php if ($this->_var['goods']['_specs']['0']['price_1'] == 0): ?><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?><?php else: ?><?php echo price_format($this->_var['goods']['_specs']['0']['price_1']); ?><?php endif; ?> </span> </p>
					<?php endif; ?>
					<?php if ($this->_var['price_2']): ?>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价：</span> <span class="price" ectype="goods_price_2"><?php if ($this->_var['goods']['_specs']['0']['price_2'] == 0): ?><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?><?php else: ?><?php echo price_format($this->_var['goods']['_specs']['0']['price_2']); ?><?php endif; ?> </span> </p>
					<?php endif; ?>
					<?php if ($this->_var['price_3']): ?>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价：</span> <span class="price" ectype="goods_price_3"><?php if ($this->_var['goods']['_specs']['0']['price_3'] == 0): ?><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?><?php else: ?><?php echo price_format($this->_var['goods']['_specs']['0']['price_3']); ?><?php endif; ?> </span> </p>
					<?php endif; ?>
					<?php if ($this->_var['price_4']): ?>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价：</span> <span class="price" ectype="goods_price_4"><?php if ($this->_var['goods']['_specs']['0']['price_4'] == 0): ?><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?><?php else: ?><?php echo price_format($this->_var['goods']['_specs']['0']['price_4']); ?><?php endif; ?> </span> </p>
					<?php endif; ?>
					<?php if ($this->_var['price_5']): ?>
					<p class="J_IsNotPro" <?php if ($this->_var['goods']['_specs']['0']['pro_price']): ?> style="display:none"<?php endif; ?>> <span class="t"> 会<ins style="margin:0 6px;">员</ins>价：</span> <span class="price" ectype="goods_price_5"><?php if ($this->_var['goods']['_specs']['0']['price_5'] == 0): ?><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?><?php else: ?><?php echo price_format($this->_var['goods']['_specs']['0']['price_5']); ?><?php endif; ?> </span> </p>
					<?php endif; ?>
					<?php endif; ?>
					<?php if ($this->_var['pv_view']): ?>
					<p><span class="t"> <?php echo $this->_var['pv_view']; ?>：</span> <span class="d-name" ><?php echo $this->_var['goods']['pv']; ?> </span></p>
					<?php endif; ?>
					<?php if ($this->_var['integral_enabled'] && $this->_var['goods']['exchange_price']): ?>
					<p> <span class="t">积分抵扣：</span> <span class="discount-info"> <b class="d-name">需使用<?php echo $this->_var['goods']['max_exchange']; ?> 积分 </b> <b class="d-price">抵 <?php echo price_format($this->_var['goods']['exchange_price']); ?> 元</b> <b class="d-price">积分不足无法购买</b></span> </p>
					<?php endif; ?>
					...
					<div class="content">
						...
						<dl class="border-b contact_us dl-c-s clearfix">
							...
							<dd> 
								...
								<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>&site=qq&menu=yes"> <img border="0" src="http://wpa.qq.com/pa?p=1:<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>:4" alt="qq" title="qq" /> </a> 
								<?php endif; ?> 
