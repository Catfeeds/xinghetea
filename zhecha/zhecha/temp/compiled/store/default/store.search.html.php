...
?>
                    <script type="text/javascript">
                        $(function() {
                            ...
                            $('#sg_<?php echo $this->_foreach['fe_s']['iteration']; ?>').raty({
                                readOnly: true,
                                score: '<?php echo $this->_var['sgoods']['goods_evaluation']; ?>'
                            });
                        })
                    </script>
                    <li class="float-left">
                        <dl>
                            <dt class="border">
                                <a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. '&store_id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank">
                            ...
                            <dd class="mt10" id="sg_<?php echo $this->_foreach['fe_s']['iteration']; ?>">
                                <span>
                                </span>
                            </dd>
                            <dd class="price mt10 w-full clearfix">
                                ...
                                <em>
                                    <a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. '&store_id=' . $this->_var['store']['store_id']. '&act=saleslog'); ?>#module" target="_blank">
                                        售出<?php echo $this->_var['sgoods']['sales']; ?>
                                    </a>
                                    &nbsp;|&nbsp;
                                    <a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. '&store_id=' . $this->_var['store']['store_id']. '&act=comments'); ?>#module" target="_blank">
