...
<div class="w">
    ...
    <div class="searchbox">
		...
		<button type="button" class="btn-primary J_SearchButton"><div class="btn-txt">快速找到类目</div></button>
		<ul class="J_SearchList search-list hidden"></ul>
	</div>
</div>
            	...
            	<li class="cc-list-each" parent_id="0">
                	<ul class="cc-tree">
                    	<li class="cc-tree-group">
                        	<?php $_from = $this->_var['gcategories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
...
?>
	...
	<div class="cate-path">
    	<dl>
       	 	<div class="clearfix">
            	<dt>您当前选择的是：</dt> 
            	<dd><div class="text J_CategoryPath">无</div></dd>
       		</div>
    	</dl>
	...
	<div class="w cateBottom">
		<div class="cateBtn">
			...
			<button disabled="disabled" hidefocus="true" id="J_Publish" />我已选择好分类，现在上传商品</button>
		</div>
	</div>
