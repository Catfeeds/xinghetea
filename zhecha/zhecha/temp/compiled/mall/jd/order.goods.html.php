...
?>
      <dl class="goods-each clearfix" <?php if (! ($this->_foreach['fe_goods']['iteration'] <= 1)): ?> style="border-top:0;"<?php endif; ?>>
        ...
        <dd class="price"><?php echo price_format($this->_var['goods']['price']); ?>+<?php echo $this->_var['goods']['max_exchange']; ?>积分</dd>
        <dd class="quantity"><?php echo $this->_var['goods']['quantity']; ?></dd>
        <dd class="promotion"></dd>
        <dd class="subtotal fs14 J_Subtotal-<?php echo $this->_var['store_id']; ?>" price="<?php echo $this->_var['goods']['subtotal']; ?>" exchange="<?php echo $this->_var['goods']['subtotal_exchange']; ?>"><?php echo price_format($this->_var['goods']['subtotal']); ?>+<?php echo $this->_var['goods']['subtotal_exchange']; ?>积分</dd>
      </dl>
...
?>
      ...
      <div class="order-confirm-extra w clearfix">
        <div class="postscript float-left mt10 clearfix">
          <div class="float-left ml10">给卖家的附言：</div>
...
?>
        ...
        <div class="confirm-extra-bottom w float-left"> <span class="mr10 price mr20 store-amount-fields">店铺合计（含运费）：&nbsp;&nbsp; <i>&yen; <em class="mr20 J_OrderAmount-<?php echo $this->_var['store_id']; ?>"><?php echo $this->_var['order']['amount']; ?>+<?php echo $this->_var['order']['amount_exchange']; ?>积分</em></i> </span> </div>
      </div>
    </div>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
  </div>
