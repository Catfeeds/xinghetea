				...
				<div class="info2">
					<form method="post" id="delivery_template">
						<table class="infoTable" align="center">
							<tr>
								<td align="left" width="80" height="25">模板名称：</td>
            				...
            				<tr>
								<td align="left" width="80" height="25">运送方式：</td>
...
?>																																																																	 										<div class="section">
           					...
           					<tr>
            					<td></td>
               					<td height="50"><span class="btn-alipay"><input type="submit" value="提交" class="submit J_SubmitDelivery" /></span></td>
           					</tr>
        				</table>
					</form>
				</div>
