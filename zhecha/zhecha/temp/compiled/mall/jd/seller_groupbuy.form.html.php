...
function check_spec(){
    ...
    $('#submit_group').click(function(){
        ...
        $('*[ectype="spec_item"]').each(function(){
            ...
            var if_checked = $(this).find('input[name="spec_id[]"]').prop('checked');
            if_checked && qty++;
                ...
                <form method="post" id="group_form" enctype="multipart/form-data">
                    <div class="information_index">
                        ...
                        <div class="add_wrap">
                            ...
                            <div class="assort">
                                <p class="txt">活动图片:
                                <input type="file" name="group_image" /> <span class="red">*</span>（大小：270像素*200像素）</p>
                        ...
                        <div class="add_wrap">
                            ...
                            <div class="assort">
                                ...
                                <?php if (! $this->_var['goods']): ?>
                                    <input gs_id="goods_id" gs_name="goods_name" gs_callback="gs_callback" gs_title="选择商品" gs_width="480" gs_type="store" gs_store_id="<?php echo $this->_var['store_id']; ?>" ectype="gselector" type="text" name="goods_name" id="goods_name" value="<?php echo htmlspecialchars($this->_var['group']['goods_name']); ?>" class="text" /> <span class="red">*</span>
                                <?php else: ?>
