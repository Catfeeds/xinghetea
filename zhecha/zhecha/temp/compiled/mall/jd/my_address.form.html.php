...
<div class="add">
    <div id="warning"></div>
    <form method="post" action="index.php?app=my_address&act=<?php echo $this->_var['act']; ?>&addr_id=<?php echo $this->_var['address']['addr_id']; ?>&ret_url=<?php echo urlencode($_GET['ret_url']); ?>" id="address_form" target="iframe_post">
    <ul>
        <li>
            <h3>收货人姓名: </h3>
        ...
        <li>
            <h3>手&nbsp;&nbsp;&nbsp;机:</h3>
            <p><input type="text" class="text width_normal" name="phone_mob" value="<?php echo $this->_var['address']['phone_mob']; ?>"/><label class="field_message"><span class="field_notice">手&nbsp;&nbsp;&nbsp;机</span></label></p>
        </li>
        <li>
        	<h3>设为默认:</h3>
            <p style="line-height: 24px;">
                <label>
                     <input type="radio"  style="margin-right:5px;" name="setdefault" value="0" <?php if ($this->_var['address']['setdefault'] == 0): ?>checked="checked"<?php endif; ?> />否   </label>
               <label>
                   <input type="radio" name="setdefault" value="1" <?php if ($this->_var['address']['setdefault'] == 1): ?>checked="checked"<?php endif; ?> />是 </label>
             </p>
        </li>
    </ul>
