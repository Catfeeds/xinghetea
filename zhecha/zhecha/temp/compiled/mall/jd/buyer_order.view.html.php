	...
	<div class="particular">
		<div class="particular_wrap">
			...
			<div class="mb20 mt10 clearfix">
				...
				<div class="time float-left">下单时间&nbsp;:&nbsp;<?php echo local_date("Y-m-d H:i:s",$this->_var['order']['order_add_time']); ?></div>
			</div>
			<h3>订单信息</h3>
			<dl class="info">
				<dt>卖家信息</dt>
				...
				<dd>手&nbsp;&nbsp;&nbsp;机&nbsp;:&nbsp;<?php echo (htmlspecialchars($this->_var['order']['phone_mob']) == '') ? '-' : htmlspecialchars($this->_var['order']['phone_mob']); ?></dd>
...
?>
					<div class="ware_list <?php if ($this->_var['goods']['erpgift'] == 1): ?>relative<?php endif; ?>">
						<div class="ware_pic"><img src="<?php echo $this->_var['goods']['goods_image']; ?>" width="50" height="50"  /></div>
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['order']['seller_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a><?php if ($this->_var['goods']['erpgift'] == 1): ?> <em class="label-gift">赠品</em><?php endif; ?><?php if ($this->_var['group_id']): ?><a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group_id']. ''); ?>"><strong class="color8">[团购]</strong></a><?php endif; ?> <br />
								<span><?php echo htmlspecialchars($this->_var['goods']['specification']); ?></span> </div>
							<div class="ware_text2"> <span>数量&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['quantity']; ?></strong></span> <span>价格&nbsp;:&nbsp;<strong><?php echo price_format($this->_var['goods']['price']); ?></strong></span> </div>
						</div>
					</div>
...
?>
					<div class="ware_list relative">
						...
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=gift&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['order']['seller_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a><em class="label-gift">赠品</em></div>								
							<div class="ware_text2"> <span>数量&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['quantity']; ?></strong></span> <span>价格&nbsp;:&nbsp;<strong><?php echo price_format($this->_var['goods']['price']); ?></strong></span> </div>
						</div>
					</div>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
