...
<style type="text/css">
.w{width:990px;}
.apply-submit .input{width: 300px;}
</style>
		...
		<div class="w content clearfix">
			<div class="left">
				...
				<ul class="list">
					<li><i></i>入驻流程</li>
					<li><i></i>签订入驻协议</li>
					<li class="current"><i></i>填写商家信息</li>
					<li><i></i>平台审核</li>
					<li><i></i>店铺开通</li>
				</ul>
				<div class="title">
...
?>
								<li class="each" sgid="<?php echo $this->_var['sgrade']['grade_id']; ?>">
									<h2><?php echo $this->_var['sgrade']['grade_name']; ?></h2>
									<p>
										<span>商品数：<em><?php echo $this->_var['sgrade']['goods_limit']; ?></em></span>&nbsp;&nbsp;
										<span>上传空间(MB)：<em><?php echo $this->_var['sgrade']['space_limit']; ?></em></span>
									</p>
									<p>
										<span>模板数：<em><?php echo $this->_var['sgrade']['skin_limit']; ?></em></span>&nbsp;&nbsp;
					   ...
					   <dl>
						...
						<dl>
						 ...
						 <dl>
						  ...
						  <dl class="clearboth">
						  	<dt>&nbsp;</dt>
						  	<dd><input class="btn-apply border0 fs14 sdlong fff pointer" type="submit" value="提交" /></dd>
						 </dl>
				   </form>
				</div>
			</div>
