...
?>
			<dl class="relative clearfix <?php if ($this->_foreach['fe_scategory']['iteration'] > 4): ?>hidden hidden-item<?php endif; ?>">
...
?>
									<dl>
										<dt><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank"><img width="160" height="160" class="lazyload" initial-url="<?php echo $this->_var['goods']['default_image']; ?>" /></a></dt>
										<dd>
											<div class="desc"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?></a></div>
