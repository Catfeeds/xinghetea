...
$(function(){
    ...
    $('#partner_form').validate({
        ...
        rules : {
            title : {
                required : true,
                rangelength: ['',100,'<?php echo $this->_var['charset']; ?>']
            },
            link  : {
                required : true,
                url      : true
                ...
                <div class="sign_box">
                    <div class="sign_con">
                        ...
                        <div class="upload_pic">
                            <span class="file1"><input type="file" size="1" hidefocus="true" ectype="logo"/></span>
                            <span class="file2"><input type="file" size="1" hidefocus="true" ectype="logo"/></span>
