	...
	<div class="particular">
		<div class="particular_wrap">
			...
			<div class="mb20 mt10 clearfix">
				<div class="state float-left">订单状态&nbsp;:&nbsp;<strong><?php echo call_user_func("order_status",$this->_var['order']['status']); ?></strong></div>
				<div class="num float-left">订单号&nbsp;:&nbsp;<?php echo $this->_var['order']['order_sn']; ?></div>
				<div class="time float-left">下单时间&nbsp;:&nbsp;<?php echo local_date("Y-m-d H:i:s",$this->_var['order']['add_time']); ?></div>
			</div>
			<h3>订单信息</h3>
			<dl class="info">
				<dt>买家信息</dt>
				...
				<dd>手&nbsp;&nbsp;&nbsp;机&nbsp;:&nbsp;<?php echo ($this->_var['order']['phone_mob'] == '') ? '-' : $this->_var['order']['phone_mob']; ?></dd>
...
?>
					<div class="ware_list">
						...
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&store_id=' . $this->_var['order']['seller_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a> <?php if ($this->_var['group_id']): ?><a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group_id']. ''); ?>"><strong class="color8">[团购]</strong></a><?php endif; ?> <br />
								<span><?php echo htmlspecialchars($this->_var['goods']['specification']); ?></span> </div>
							<div class="ware_text2"> <span>数量&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['quantity']; ?></strong></span> <span>单价&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['price']; ?></strong></span> 
								<?php if ($this->_var['goods']['sku']): ?><span>货号&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['sku']; ?></strong></span><?php endif; ?> 
							</div>
						</div>
					</div>
    ...
    foreach ($_from AS $this->_var['goods']):
?>
					<div class="ware_list relative">
						<div class="ware_pic"><img src="<?php echo $this->_var['goods']['default_image']; ?>" width="50" height="50"  /></div>
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=gift&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a>
							<em class="label-gift">赠品</em></div>
							<div class="ware_text2"> <span>数量&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['quantity']; ?></strong></span> <span>单价&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['price']; ?></strong></span> 
							</div>
						</div>
					</div>
					...
					<div class="transportation">配送费用&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order_extm']['shipping_fee']); ?><strong>(<?php echo htmlspecialchars($this->_var['order_extm']['shipping_name']); ?>)</strong></span>优惠打折&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['discount']); ?></span>订单总价&nbsp;:&nbsp;<b><?php echo price_format($this->_var['order']['order_amount']); ?></b> </div>
			...
			<h3>收货人及物流信息</h3>
			<div class="goods"> 收货地址&nbsp;:&nbsp;<?php echo htmlspecialchars($this->_var['order_extm']['consignee']); ?><?php if ($this->_var['order_extm']['phone_mob']): ?>, &nbsp;<?php echo $this->_var['order_extm']['phone_mob']; ?><?php endif; ?><?php if ($this->_var['order_extm']['phone_tel']): ?>,&nbsp;<?php echo $this->_var['order_extm']['phone_tel']; ?><?php endif; ?> 
...
?>
				<li> <span class="operator"><?php if ($this->_var['log']['operator'] == '0'): ?><span style="color:green;">[系统]</span><?php else: ?><?php echo htmlspecialchars($this->_var['log']['operator']); ?><?php endif; ?></span> 在 <span class="log_time"><?php echo local_date("Y-m-d H:i:s",$this->_var['log']['log_time']); ?></span> 将订单状态从 <span class="order_status"><?php echo $this->_var['log']['order_status']; ?></span> 改变为 <span class="order_status"><?php echo $this->_var['log']['changed_status']; ?></span> 
