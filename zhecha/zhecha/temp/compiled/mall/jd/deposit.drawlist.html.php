...
?>
                        	<li class="clearfix">
                                ...
                                <div class="info"><?php echo sub_str($this->_var['record']['title'],30); ?></div>
                        		<div class="tradeNo"><?php echo $this->_var['record']['bizOrderId']; ?> | <?php echo $this->_var['record']['tradeNo']; ?></div>
                            	<div class="method"><span class="f60">支出</span></div>
                            	<div class="money"><?php echo $this->_var['record']['amount']; ?></div>
                            	<div class="fundchannel"><?php echo $this->_var['record']['card_info']['bank_name']; ?><br /><span class="gray"><?php echo $this->_var['record']['card_info']['num']; ?></span></div>
                            	<div class="status">
                        ...
                        <div class="notice-word mt10"><p>没有符合条件的记录 <a href="<?php echo url('app=deposit&act=withdraw'); ?>">马上提现</a></p></div>
                        <?php endif; ?>
                    </div>
