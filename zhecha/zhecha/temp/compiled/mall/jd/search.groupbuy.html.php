...
?>
                 	<li class="item mb20" <?php if ($this->_foreach['fe_group']['iteration'] % 4 == 0): ?> style="margin-right:0"<?php endif; ?>>
                 		...
                 		<div class="desc"><a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group']['group_id']. ''); ?>"><?php echo sub_str(htmlspecialchars($this->_var['group']['group_name']),70); ?></a></div>
                 		<div class="pic"><a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group']['group_id']. ''); ?>"><img src="<?php if ($this->_var['group']['group_image']): ?><?php echo $this->_var['group']['group_image']; ?><?php else: ?><?php echo $this->_var['group']['default_image']; ?><?php endif; ?>"  <?php if ($this->_var['group']['group_image']): ?>width="270"<?php else: ?>width="200"<?php endif; ?> height="200" alt="<?php echo htmlspecialchars($this->_var['group']['group_name']); ?>" /></a></div>
                    	...
                    	<div class="extra clearfix">
                            <span class="float-left"><strong><?php echo $this->_var['group']['quantity']; ?></strong>人参与</span>
                            <?php if ($this->_var['group']['state'] == 2): ?>
                            ...
                            <?php else: ?>
                            <span class="countdown float-right"><i class="tm NumDays"><?php echo $this->_var['group']['lefttime']['d']; ?></i><em>天 </em><i class="tm NumHours"><?php echo $this->_var['group']['lefttime']['h']; ?></i><em>小时</em><i class="tm NumMins"><?php echo $this->_var['group']['lefttime']['m']; ?></i><em>分</em><i class="tm NumSeconds"><?php echo $this->_var['group']['lefttime']['s']; ?></i><em>秒</em>结束</span>
                            <?php endif; ?>
