            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        ...
                        <div class="photo relative2">
                            ...
                            <span class="explain">此处为您的店铺条幅，将显示在店铺导航上方的banner位置，建议尺寸 >=1920*120 像素</span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="setup info shop">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr style="display:none">
                             ...
                             <tr>
                                  <th>主营业务：</th>
                                  <td><input type="text" name="business_scope" class="text width_normal"  value="<?php echo $this->_var['store']['business_scope']; ?>" style="width:350px;" /> <span class="padding1">如：女装上衣 t恤 衬衫 长袖 纯色 打底裤</span></td>
                            </tr>
...
?>
                                        <li ectype="handle_pic" file_name="<?php echo htmlspecialchars($this->_var['file']['file_name']); ?>" file_path="<?php echo $this->_var['file']['file_path']; ?>" file_id="<?php echo $this->_var['file']['file_id']; ?>">
                                            ...
                                            <div class="pic">
                                            	<img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['file']['file_path']; ?>" width="80" height="80" alt="<?php echo htmlspecialchars($this->_var['file']['file_name']); ?>" title="<?php echo htmlspecialchars($this->_var['file']['file_name']); ?>" />
											</div>
