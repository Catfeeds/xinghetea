...
<?php echo $this->fetch('member.submenu.html'); ?>
        <div class="wrap">
            <div class="public table">
                <table>
                    <div class="eject_btn_two eject_pos1" title="添加"><b class="ico3" ectype="dialog" dialog_title="添加" dialog_id="coupon_add" dialog_width="480" uri="index.php?app=coupon&amp;act=add">新增优惠券</b></div>
