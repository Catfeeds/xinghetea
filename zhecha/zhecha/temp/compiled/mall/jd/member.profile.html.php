                ...
                <form method="post" enctype="multipart/form-data" id="profile_form">
                    <div class="information">
                        ...
                        <div class="photo width13">
                            ...
                            <b>
                                <span class="file1"><input type="file" size="1" hidefocus="true" ectype="change_avatar" name="portrait1" /></span>
                                <span class="file2"><input type="file" size="1" hidefocus="true" ectype="change_avatar" name="portrait2" /></span>
