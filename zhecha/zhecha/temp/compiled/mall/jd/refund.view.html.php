...
<style type="text/css">
.refund_info{padding:10px; line-height:24px;}
.refund_btn{padding:10px;}
ul{line-height:none}
.refund_form input{vertical-align:middle}
.refund_message{background:#FFF7EB;padding:20px;border:1px #ddd solid;width:798px;}
...
.message_list .content{background:#fff;padding:10px;border:1px #ddd solid;border-top:0;width:776px;border-bottom:0;}
...
.refund_message textarea{vertical-align:middle;width:788px; height:40px; background:#fff; font-size:12px;padding:5px;}
            ...
            <div class="public refund_form">
            	<ul class="refund_info">
                    ...
                    <div class="refund_fee_detail">
                    	<h3>该订单退款总额 <?php echo price_format($this->_var['refund']['refund_total_fee']); ?></h3>
                    	<p>

                        	<li class="first">退款金额：<?php echo price_format($this->_var['refund']['refund_goods_fee']); ?> <span class="gray">(商品总额：<?php echo price_format($this->_var['refund']['goods_fee']); ?>)</span></li>
                ...
                <div class="refund_message">
                	...
                	<ul class="message_form clearfix">
                    	<li><textarea name="content" class="text border"></textarea></li>
...
?>
                    ...
                    <div class="page-bottom mt10 clearfix">
