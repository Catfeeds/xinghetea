...
$(function(){
	$("#refund_form").submit(function(){
		...
		if($('input[name="refund_shipping_fee"]').val()<0){
			...
			alert('退运费金额不能大于该订单的运费总额:<?php echo $this->_var['refund']['shipping_fee']; ?>');
			return false;
		}
                	...
                	<table>
                    	<tr>
                            ...
                            <td>
                                ...
                                <span class="gray">（最多<?php echo price_format($this->_var['refund']['goods_fee']); ?>元）</span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="gray">（最多<?php echo $this->_var['refund']['shipping_fee']; ?>元。如果不是质量问题，卖家可以拒绝）</span>
