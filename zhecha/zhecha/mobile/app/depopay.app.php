...
class DepopayApp extends MemberbaseApp
{
    ...
    function pay()
    {
		...
		if(!IS_POST)
		{
			...
			$this->import_resource(array('script' => 'mobile/jquery.plugins/jquery.validate.js'));
    ...
    function heepay_success(){
        $this->show_message('pay_successed','back_list','index.php?app=buyer_order');
    }
}
