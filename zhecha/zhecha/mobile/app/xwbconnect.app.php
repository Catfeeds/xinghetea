...
class XwbconnectApp extends MallbaseApp
{
	var $_member_mod;
	var $_bind_mod;
	var $_app;
    ...
    function XwbconnectApp()
    {
		...
		$this->_config = $this->_get_plugin_conf(array('name'=>'xwbconnect','event'=>'on_xwb_login'));
    }
	function callback()
	{
		...
		if ($token) 
		{
			...
			{
				// 进入绑定模式
				$_SESSION['bind'] = array('unionid' => $unionid, 'app' => $this->_app, 'bind_expire_time' => gmtime() + 600);
