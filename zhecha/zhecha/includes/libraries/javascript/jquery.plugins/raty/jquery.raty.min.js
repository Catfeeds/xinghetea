...
; (function(b) {
    var a = {
        ...
        _bindClick: function() {
            ...
            function(e) {
                ...
                if (c.opt.click) {
                    c.opt.click.call(c, parseFloat(c.score.val()).toFixed(2), e);
                }
            });
        },
            ...
            if (this.opt.target) {
                ...
                if (f === undefined) {
                    ...
                    if (f === null) {
                        ...
                        }else if(this.opt.targetType == 'hintsMixScore'){
							 if(f > 5)  f = 5;
							 f = '<b class="score mr10">'+parseFloat(f).toFixed(2)+'</b>'+a._getHint.call(this, Math.ceil(f));
						}
						else {
                            if (this.opt.precision) {
    ...
    b.fn.raty.defaults = {
        ...
        half: false,
        halfShow: true,
        hints: [lang.worse, lang.bad, lang.soso, lang.good, lang.better],
        iconRange: undefined,
        mouseout: undefined,
        mouseover: undefined,
