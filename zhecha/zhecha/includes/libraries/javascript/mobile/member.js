$(function(){
	...
	$('*[ectype="gselector"]').on('click', function(event){
        ...
        ajax_form(id, title, REAL_SITE_URL + '/index.php?app=gselector&act=' + type + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width, style, opacity);
        return false;
    });
