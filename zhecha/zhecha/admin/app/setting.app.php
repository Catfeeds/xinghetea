...
class SettingApp extends BackendApp
{
    ...
    function base_setting()
    {
        ...
        else
        {
            ...
            {
                if($image_urls && isset($image_urls[$image]) && $image_urls[$image] != false){
...
//            $data['disaplay_sales_volume']      = $_POST['disaplay_sales_volume'];
            ...
            $this->json_result(array('rel'=>1),'edit_base_setting_successed');
        }
    }
...
//            $data['site_postcode']          = $_POST['site_postcode'];
			...
			$data['baidukey']  =  empty($_POST['baidukey']) ? array() : $_POST['baidukey'];
			

            $model_setting->setAll($data);

            $this->json_result(array('rel'=>1),'edit_base_information_successed');
        }
    }
    ...
    function email_setting()
    {
        ...
        else
        {
            ...
            $this->json_result(array('rel'=>1),'edit_email_setting_successed');
        }
    }
...
//            $data['captcha_error_login']    = $_POST['captcha_error_login'];
            ...
            $this->json_result(array('rel'=>1),'edit_captcha_setting_successed');
        }
    }
...
//            $data['auto_evaluate']      = $_POST['auto_evaluate'];
            ...
            $this->json_result(array('rel'=>1),'edit_credit_setting_successed');
        }
    }
    ...
    function subdomain_setting()
    {
        ...
        else
        {
            ...
            $this->json_result(array('rel'=>1),'edit_subdomain_setting_successed');
        }
    }
