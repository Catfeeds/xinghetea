...
class BrandApp extends BackendApp
{
	...
	function get_xml()
	{
		...
		foreach ($brands as $k => $v){
			...
			$list['brand_name'] = '<span ectype="inline_edit" fieldname="brand_name" fieldid="'.$v['brand_id'].'"  required="1" class="editable" title="'.Lang::get('editable').'">'.$v['brand_name'].'</span>';
			...
			$list['recommended'] = $v['recommended'] == 0 ? '<span class="no"><i class="fa fa-ban"></i>否</span>' : '<span class="yes"><i class="fa fa-check-circle"></i>是</span>';
