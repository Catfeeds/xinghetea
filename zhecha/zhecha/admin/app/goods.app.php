...
//         dump($goods_list);die();
		foreach ($goods_list as $k => $v){
			...
			$operation .= "<li><a href='" .SITE_URL."/index.php?app=goods&id=".$v['goods_id']. "&store_id=2' target=\"_blank\">查看</a></li>";
			...
			$list['cate_name'] = $this->_goods_mod->format_cate_name($v['cate_name']);
